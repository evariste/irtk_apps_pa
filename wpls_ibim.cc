...
main (int argc, char **argv)
{
  ...
  if ((argc < 5)) {
    cout << "usage: wpls_ibim [sub0_struc1] ... [subN-1_struc1] [sub0_struc2] ... [subN-1_struc2] [IndexOfSubjectLeftOut] [modesToUse] [maxiterations]" << endl;
...
//   cout << "data1_reduced=" << endl;
  //print_matrix(data1_reduced);
//   cout << "data2_reduced=" << endl;
...
//     cout << "iteration=" << k << "matrix M norm=" << sum_abs_matrix
// (M)/(noOfModes*noOfModes) << "matrix B norm=" << sum_abs_matrix
// (B)/(noOfModes*noOfModes) << "matrix A norm=" <<sum_abs_matrix
// (A)/(noOfModes*noOfModes) <<"matrix AAT norm=" <<sum_abs_matrix
// (A_TmultA)/(noOfModes*noOfModes) << endl;
